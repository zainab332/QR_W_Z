...
class SiteWebFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_site_web, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val generateButton: Button = view.findViewById(R.id.generateUrlQR)
        ...
        generateButton.setOnClickListener {
            ...
            if (url.isNotEmpty()) {
                qrBitmap = generateQRCode(url, qrImageView)
