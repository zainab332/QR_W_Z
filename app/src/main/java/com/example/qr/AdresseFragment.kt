...
class AddressFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_adresse, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val addressInput: EditText = view.findViewById(R.id.addressInput)
        val generateButton: Button = view.findViewById(R.id.generateAddressQr)
        ...
        var qrBitmap: Bitmap? = null // Store the QR code bitmap
        ...
        generateButton.setOnClickListener {
            ...
            // Generate QR code data (e.g., "geo:0,0?q=address")
            val qrData = "geo:0,0?q=${address.replace(" ", "+")}"
            qrBitmap = generateQRCode(qrData, qrCodeImageView)
